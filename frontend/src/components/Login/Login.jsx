        ...
        <div className="changelog">
          ...
          <div>
            ...
            <div>
              ...
              <span>Request upfront deposits on your proposals(US only)</span>
              <p>
            ...
            <div>
              <p>
                improvent<h5>New settings page.</h5>The settings quicker to
                whare you need,and get a...
              </p>
            </div>
            <div>
              <p>
                improvent<button id="smlbtn">Bonsai Cash</button> You might've
                noticed the dashboard got a visual uplift. It's not just looks
                though
              </p>
            </div>
          </div>
